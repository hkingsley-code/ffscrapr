...
```
https://fantasy.espn.com/apis/v3/games/flb/seasons/{season}/segments/0/leagues/{league_id} # for 2018 onward
https://fantasy.espn.com/apis/v3/games/flb/leagueHistory/{league_id}?seasonId={season} # for 2017 or earlier
```
...
For example, [https://fantasy.espn.com/apis/v3/games/flb/seasons/2020/segments/0/leagues/899513?view=mDraftDetail](https://fantasy.espn.com/apis/v3/games/flb/seasons/2020/segments/0/leagues/899513?view=mDraftDetail)
...
draft_details_raw <- espn_getendpoint_raw(
  conn,
  "https://fantasy.espn.com/apis/v3/games/flb/seasons/2020/segments/0/leagues/899513?view=mDraftDetail")
...
player_scores_2 <- espn_getendpoint_raw(
  conn,
  "https://fantasy.espn.com/apis/v3/games/flb/seasons/2020/segments/0/leagues/899513?view=kona_player_info",
